...
> Configuration guide for **LOAD BALANCER** in Amazon Web Services.

## Overview

This guide covers setup and configuration load balancer in AWS for production environments.
