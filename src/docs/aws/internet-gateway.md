...
> Configuration guide for **INTERNET GATEWAY** in Amazon Web Services.

## Overview

This guide covers setup and configuration internet gateway in AWS for production environments.
