...
> Konfigurasi **ROUTER CONFIGURATION** in Cisco IOS.

## Overview

Step-by-step guide for configuring router configuration in Cisco IOS router and switch.
...
```cisco
! Konfigurasi router configuration
