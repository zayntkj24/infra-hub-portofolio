...
> Konfigurasi **BRIDGE** in MikroTik RouterOS.

## Overview

Practical guide for configuring bridge in MikroTik RouterOS for production networks.
...
```routeros
# Backup konfigurasi
/system backup save name=backup-before-bridge
```
