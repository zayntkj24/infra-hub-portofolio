...
> Konfigurasi **WIRELESS** in MikroTik RouterOS.

## Overview

Practical guide for configuring wireless in MikroTik RouterOS for production networks.
...
```routeros
# Backup konfigurasi
/system backup save name=backup-before-wireless
```
