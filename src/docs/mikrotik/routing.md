...
> Konfigurasi **ROUTING** in MikroTik RouterOS.

## Overview

Practical guide for configuring routing in MikroTik RouterOS for production networks.
...
```routeros
# Backup konfigurasi
/system backup save name=backup-before-routing
```
