...
> Konfigurasi **PPPOE** in MikroTik RouterOS.

## Overview

Practical guide for configuring pppoe in MikroTik RouterOS for production networks.
...
```routeros
# Backup konfigurasi
/system backup save name=backup-before-pppoe
```
