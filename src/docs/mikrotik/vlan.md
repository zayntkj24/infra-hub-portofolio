...
> Konfigurasi **VLAN** in MikroTik RouterOS.

## Overview

Practical guide for configuring vlan in MikroTik RouterOS for production networks.
...
```routeros
# Backup konfigurasi
/system backup save name=backup-before-vlan
```
