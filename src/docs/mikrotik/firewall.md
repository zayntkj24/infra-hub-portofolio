...
> Konfigurasi **FIREWALL** in MikroTik RouterOS.

## Overview

Practical guide for configuring firewall in MikroTik RouterOS for production networks.
...
```routeros
# Backup konfigurasi
/system backup save name=backup-before-firewall
```
